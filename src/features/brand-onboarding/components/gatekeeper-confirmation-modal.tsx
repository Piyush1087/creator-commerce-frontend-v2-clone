    ...
    <div className="gk-modal-backdrop" role="presentation">
      ...
      >
        ...
        <div className="gk-industry-card">
          ...
          <div className="gk-industry-options" role="group" aria-label="Industry">
          ...
          <div className="gk-coming-soon">
            ...
            <div className="gk-industry-options">
        ...
        {isOverride ? (
          <div className="gk-warning" role="alert">
            ...
            <div>
              ...
              <button type="button" onClick={onResetIndustry} disabled={isStarting}>
                Keep {detectedLabel}
              </button>
            </div>
          </div>
        ...
        <div className="gk-scan-summary">
          <div><Clock3 size={18} aria-hidden /><span><strong>Deeper brand analysis</strong><small>Usually takes a few minutes; timing varies by site.</small></span></div>
          <div><ShieldCheck size={18} aria-hidden /><span><strong>No extra access required now</strong><small>A domain-linked work email and Meta / Instagram access may be useful later, but are not required to start.</small></span></div>
          <div><Check size={18} aria-hidden /><span><strong>You stay in control</strong><small>You’ll review the resulting Intelligence before it becomes part of your working brand context.</small></span></div>
        </div>
        ...
        <div className="gk-modal__actions">
          {isUnsupported ? (
            ...
            >
              {isStarting ? "Starting…" : isOverride ? `Continue with ${selectedLabel}` : "Start Brand Intelligence Scan"}
            </Button>
          )}
