  ...
  const handleStartTrial = async () => {
    ...
    try {
      try {
        ...
        if (
          !(trialError instanceof PricingApiError && trialError.status === 409)
        ) {
          throw trialError;
        }
      }
      ...
      setError(
        err instanceof Error ? err.message : "Could not start your trial.",
      );
    } finally {
    ...
    <div className="bob-landing">
      ...
      >
        ...
        <div className="bob-pricing-card">
          ...
          <p className="bob-pricing-subcost">
            $99/mo after 30 days + 7% commission
          </p>

          <p className="bob-pricing-desc">
            Unlock full platform capabilities during our exclusive preview
            phase. Shape the future of creator operations with direct access to
            our founding engineering team.
          </p>
          ...
          <div className="bob-pricing-features">
            <div className="bob-pricing-feature-group">
              ...
              <ul>
                <li>
                  <CheckCircle2 size={18} /> Real-time Brand DNA Extraction
                </li>
                <li>
                  <CheckCircle2 size={18} /> 3-Competitor Gap Analysis
                </li>
                <li>
                  <CheckCircle2 size={18} /> 1 Full Monthly Refresh
                </li>
              </ul>
            </div>
            ...
            <div className="bob-pricing-feature-group">
              ...
              <ul>
                <li>
                  <CheckCircle2 size={18} /> AI-Generated Creative Briefs
                </li>
                <li>
                  <CheckCircle2 size={18} /> 5 Products & 3 Collections
                </li>
                <li>
                  <CheckCircle2 size={18} /> 3 Managed Locations
                </li>
              </ul>
            </div>
            ...
            <div className="bob-pricing-feature-group">
              ...
              <ul>
                <li>
                  <CheckCircle2 size={18} /> Unlimited Persona Matching
                </li>
                <li>
                  <CheckCircle2 size={18} /> 100 Automated Outreaches
                </li>
                <li>
                  <CheckCircle2 size={18} /> Secure Escrow Protection
                </li>
              </ul>
            </div>
          </div>
          ...
          <p className="bob-pricing-note">
            No credit card required. Instant access to Phase 2.
          </p>
