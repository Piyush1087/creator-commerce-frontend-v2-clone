...
describe("C05-P1C Creator Instagram frontend boundaries", () => {
  ...
  it("is composed by P2 through the settings route and callback facade", () => {
    const routes = source("src/routes/app-routes.tsx");
    expect(routes).toContain("CreatorSettingsInstagramPage");
    expect(routes).toContain("CreatorInstagramOAuthCallbackRoute");
